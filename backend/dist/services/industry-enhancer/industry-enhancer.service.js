...
exports.IndustryEnhancerService = void 0;
const common_1 = require("@nestjs/common");
let IndustryEnhancerService = class IndustryEnhancerService {
    getSpecializedKnowledge(framework, industry) {
        const knowledgeMap = {
            'quantum-computing': {
...
Phase 4 (18+ months): Advanced blockchain security features
    ...
    enhanceDocumentWithSpecializedKnowledge(content, framework, industry) {
...
${specializedKnowledge.successMetrics.map(sm => `- ${sm}`).join('\n')}
    ...
    getFrameworkSpecificQuestions(framework) {
...
exports.IndustryEnhancerService = IndustryEnhancerService;
exports.IndustryEnhancerService = IndustryEnhancerService = __decorate([
    (0, common_1.Injectable)()
], IndustryEnhancerService);
//# sourceMappingURL=industry-enhancer.service.js.map