...
export declare class DocumentService {
    ...
    constructor(prisma: PrismaService, config: ConfigService, smartPrompt: SmartPromptService, contentQuality: ContentQualityService, universal: UniversalDocumentService);
