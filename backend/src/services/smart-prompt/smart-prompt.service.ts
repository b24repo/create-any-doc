...
- API compliance and regulatory requirements
  ...
  private getFrameworkSpecificQualityStandards(framework: string): string {
  ...
  private getDocumentStructure(documentType: string, framework: string): string {
    const baseStructure = `
...
- Blockchain compliance and regulatory requirements
  ...
  private getFrameworkSpecificOutputRequirements(framework: string): string {
